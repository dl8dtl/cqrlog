...
begin
  ...
  fGlobalMembersDir := ExpandFileNameUTF8(fShareDir+'members'+PathDelim);

  if DirectoryExistsUTF8(fHomeDir+'zipcodes') then
    fZipCodeDir := fHomeDir+'zipcodes'+PathDelim
  else
    fZipCodeDir := ExpandFileNameUTF8(fShareDir+'zipcodes'+PathDelim);

  if not DirectoryExistsUTF8(fHomeDir+'images') then
    CreateDirUTF8(fHomeDir+'images');

  fHelpDir := ExpandFileNameUTF8(fShareDir+'help'+PathDelim);
...
var
  s,d : String;
begin
  s := ExpandFileNameUTF8(fShareDir+'ctyfiles'+PathDelim);
...
var
  s,d : String;
begin
  s := ExpandFileNameUTF8(fShareDir+'xplanet'+PathDelim);
...
var
  s,d : String;
begin
  s := ExpandFileNameUTF8(fShareDir+'voice_keyer'+PathDelim);
